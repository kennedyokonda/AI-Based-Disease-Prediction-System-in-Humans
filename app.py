...
df_tr = pd.read_csv(
    r'/home/ken/project2/Chatbot/Medical_dataset/Training.csv')

df_tr = pd.read_csv(
    r'/home/ken/project2/Chatbot/Medical_dataset/Testing.csv')
...
def getDescription():
    ...
    file_path = '/home/ken/project2/Chatbot/Medical_dataset/symptom_Description.csv'
...
def getSeverityDict():
    ...
    file_path = '/home/ken/project2/Chatbot/Medical_dataset/symptom_severity.csv'
    with open(file_path) as csv_file:
...
def getprecautionDict():
    ...
    file_path = '/home/ken/project2/Chatbot/Medical_dataset/symptom_precaution.csv'
    with open(file_path) as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        line_count = 0
        for row in csv_reader:
...
def get_bot_response():
    ...
    if session['step'] == "BYE":
        ...
        if s.lower() == "yes":
            ...
            return "THANKS" + name + " for using me for more information please contact <b> +254796435982</b>"
